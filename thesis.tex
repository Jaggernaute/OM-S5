...
\includeonlysmart{
  ...
  chapters/1-evf,
  chapters/3-norme,
  chapters/4-convergeance,
  chapters/5-produit-scalaire,
  chapters/6-systemes
}
...
\include{chapters/3-norme}
\include{chapters/4-convergeance}
\include{chapters/5-produit-scalaire}
\include{chapters/6-systemes}
